...
export const Hero = () => (
  <section className={s.hero}>
    <Container>
      <div className={s['hero__head-group']}>
        <h1 className={s.hero__title}>Авторские букеты</h1>
        <p className={s.hero__subtitle}>и подарки</p>
      </div>

      <figure className={s['hero__group-image']}>
        <picture className={cn(s.hero__image, s.hero__image_left)}>
        ...
        <svg
          className={cn(s.hero__image, s.hero__image_center)}
          role='img'
        ...
        >
          ...
          <foreignObject clipPath='url(#hero)' width='100%' height='100%'>
            <div className={s['hero__image-center']}></div>
          </foreignObject>
        </svg>

        <picture className={cn(s.hero__image, s.hero__image_right)}>
