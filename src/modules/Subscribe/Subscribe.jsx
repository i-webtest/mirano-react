...
export const Subscribe = () => (
  <section className={s.subscribe}>
    <Container>
      <h2 className={s.subscribe__title}>Подпишись на&nbsp;рассылку</h2>

      <form className={s.subscribe__form} action='#'>
        <input className={s.subscribe__input} type='email' name='email' placeholder='E-mail' />

        <button className={s.subscribe__button} aria-label='подписаться на рассылку'>
